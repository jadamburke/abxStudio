...
set "MAYA_SCRIPT_PATH=%PP_RESOURCE%\maya\common\scripts;%MAYA_PPTOOLS%\scripts\production;%PP_RESOURCE%\bin\win32\vray\vray22001\maya_vray\scripts;%PP_RESOURCE%\bin\win32\arnold\%PP_ARNOLD%\mtoadeploy\2012\scripts;%PP_RESOURCE%\bin\win32\shaveHaircut\maya2012\scripts"
set "MAYA_PLUG_IN_PATH=%MAYA_PPTOOLS%\plugins;%PP_RESOURCE%\bin\win32\vray\vray22001\maya_vray\plug-ins;%PP_RESOURCE%\bin\win32\arnold\%PP_ARNOLD%\mtoadeploy\2012\plug-ins"
set "XBMLANGPATH=%PP_RESOURCE%\bin\win32\vray\vray22001\maya_vray\icons;%PP_RESOURCE%\bin\win32\arnold\%PP_ARNOLD%\mtoadeploy\2012\icons;%PP_RESOURCE%\bin\win32\shaveHaircut\maya2012\icons"
...
C:\"Program Files"\Autodesk\Maya2012\bin\mayabatch.exe %*