...
//set "MAYA_SCRIPT_PATH=%PP_RESOURCE%\maya\common\scripts;%MAYA_PPTOOLS%\scripts\production;%PP_RESOURCE%\bin\win32\vray\%PP_VRAY%\maya_vray\scripts;%PP_RESOURCE%\bin\win32\arnold\%PP_ARNOLD%\mtoadeploy\scripts;%PP_RESOURCE%\bin\win32\shaveHaircut\maya%PP_MAYA%\scripts"
set "MAYA_SCRIPT_PATH=%PP_RESOURCE%\maya\common\scripts;%MAYA_PPTOOLS%\scripts\production;%PP_RESOURCE%\bin\win32\vray\%PP_VRAY%\maya_vray\scripts;%PP_RESOURCE%\bin\win32\arnold\%PP_ARNOLD%\mtoadeploy\scripts;%PP_RESOURCE%\bin\win32\shaveHaircut\maya%PP_MAYA%\scripts;%PP_RESOURCE%\bin\win32\realflow\maya%PP_MAYA%\scripts\others"
...
set "MAYA_PLUG_IN_PATH=%MAYA_PPTOOLS%\plugins;%PP_RESOURCE%\bin\win32\vray\%PP_VRAY%\maya_vray\plug-ins;%PP_RESOURCE%\bin\win32\arnold\%PP_ARNOLD%\mtoadeploy\plug-ins;%PP_RESOURCE%\bin\win32\realflow\maya%PP_MAYA%\bin\plug-ins"
set "XBMLANGPATH=%PP_RESOURCE%\bin\win32\vray\%PP_VRAY%\maya_vray\icons;%PP_RESOURCE%\bin\win32\arnold\%PP_ARNOLD%\mtoadeploy\icons;%PP_RESOURCE%\bin\win32\shaveHaircut\maya%PP_MAYA%\icons"

set "MAYA_SHELF_PATH=%MAYA_PPTOOLS%\shelves"
set "MAYA_MODULE_PATH=%MAYA_PPTOOLS%\modules;%PP_RESOURCE%\bin\win32\arnold\%PP_ARNOLD%\mtoadeploy;%PP_RESOURCE%\bin\win32\shaveHaircut\maya%PP_MAYA%\modules"
...
C:\"Program Files"\Autodesk\"Maya%PP_MAYA%"\bin\Render.exe %*