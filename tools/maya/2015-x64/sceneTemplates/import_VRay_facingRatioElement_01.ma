...
//Name: import_VRay_facingRatioElement_01.ma
//Last modified: Thu, Mar 21, 2013 03:41:31 PM
//Codeset: 1252
requires maya "2012";
...
createNode VRaySettingsNode -s -n "vraySettings";
	...
	setAttr ".sRGBOn" yes;
	setAttr ".resf" yes;
	setAttr ".mSceneName" -type "string" "//moon/pipeline/dev/maya/2012-x64/sceneTemplates/import_VRay_facingRatioElement_01.ma";
...
createNode mentalrayOptions -s -n "PreviewImrRayTracyOn";
	...
	setAttr ".maxr" 3;
	setAttr ".shrd" 1;
createNode VRayRenderElement -n "vrayRE_FacingRatio";
...
createNode samplerInfo -n "facingRatio";
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -k on ".nds";
...
connectAttr "facingRatio.fr" "vrayRE_FacingRatio.vray_texture_extratexr";
connectAttr "facingRatio.fr" "vrayRE_FacingRatio.vray_texture_extratexg";
connectAttr "facingRatio.fr" "vrayRE_FacingRatio.vray_texture_extratexb";
connectAttr "facingRatio.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
// End of import_VRay_facingRatioElement_01.ma
