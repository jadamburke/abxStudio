...
//Name: import_VRay_greyMtl_01.ma
//Last modified: Mon, Feb 25, 2013 01:52:15 PM
//Codeset: 1252
requires maya "2012";
...
createNode shadingEngine -n "grey_mtlSG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
...
createNode VRaySettingsNode -s -n "vraySettings";
	...
	setAttr ".fnprx" -type "string" "../../../RENDER/ASSETS/Characters/Kaos/<Scene>/<Scene>";
	...
	setAttr ".vfbOn" yes;
	setAttr ".vfbSA" -type "Int32Array" 138 546 6 172 77 1332 866
		 1594 107 -3 86 82945 1 1 619 214 220 254 478
		 ...
		 0 2 1 2 -1 0 0 0 1869111636 24941 20318584 0
		 1145063920 0 16 1 1 8 315354992 0 1 0 0 0
		 -256 48 20334848 0 36969533 0 36969525 0 20318584 16777215 0 70
	...
	setAttr ".sRGBOn" yes;
	setAttr ".mSceneName" -type "string" "//moon/pipeline/dev/maya/2012-x64/sceneTemplates/import_VRay_greyMtl_01.ma";
...
relationship "link" ":lightLinker1" "grey_mtlSG.message" ":defaultLightSet.message";
relationship "link" ":lightLinker1" ":defaultObjectSet.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" ":initialShadingGroup.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" ":initialParticleSE.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" "grey_mtlSG.message" ":defaultLightSet.message";
connectAttr "layerManager.dli[0]" "defaultLayer.id";
connectAttr "renderLayerManager.rlmi[0]" "defaultRenderLayer.rlid";
connectAttr "grey_mtl.oc" "grey_mtlSG.ss";
connectAttr "grey_mtlSG.msg" "materialInfo1.sg";
connectAttr "grey_mtl.msg" "materialInfo1.m";
...
connectAttr "grey_mtlSG.pa" ":renderPartition.st" -na;
connectAttr "grey_mtl.msg" ":defaultShaderList1.s" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
connectAttr ":perspShape.msg" ":defaultRenderGlobals.sc";
// End of import_VRay_greyMtl_01.ma
