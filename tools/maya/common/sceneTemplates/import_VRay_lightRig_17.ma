...
//Name: import_VRay_lightRig_17.ma
//Last modified: Mon, Feb 18, 2013 05:32:21 PM
//Codeset: 1252
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1531.1274608840181 797.62394177736473 5077.1098519399384 ;
	setAttr ".r" -type "double3" -8.7383527296605532 17.800000000000281 -4.1755809474375951e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 5338.6033763435698;
...
createNode camera -n "renderCamShape" -p "renderCam";
	...
	setAttr ".lls" 75;
	setAttr ".dr" yes;
	setAttr ".col" -type "float3" 0.21799999 0.21799999 0.21799999 ;
...
createNode VRayLightRectShape -n "fill_lightShape" -p "fill_light";
	...
	setAttr ".vsi" 150;
	setAttr ".shad" no;
	setAttr ".intens" 0.17000000178813934;
	setAttr ".inv" yes;
	setAttr ".nd" yes;
	setAttr ".subs" 32;
...
createNode VRayLightRectShape -n "rim_lightShape" -p "rim_light";
	...
	setAttr ".usi" 150;
	setAttr ".vsi" 150;
	setAttr ".intens" 1.6000000238418579;
	setAttr ".inv" yes;
	setAttr ".nd" yes;
	setAttr ".subs" 32;
...
createNode VRayLightRectShape -n "key_lightShape" -p "key_light";
	...
	setAttr ".usi" 75;
	setAttr ".vsi" 75;
	setAttr ".intens" 0.76999998092651367;
	setAttr ".inv" yes;
	setAttr ".nd" yes;
	setAttr ".subs" 32;
...
createNode VRaySettingsNode -s -n "vraySettings";
	...
	setAttr ".vfbOn" yes;
	setAttr ".vfbSA" -type "Int32Array" 144 569 6 2318 293 824 612
		 ...
		 65536 944879383 0 -525502228 1065353216 1621981420 1018563424 1065353216 1062557013 2 0 0
	...
	setAttr ".resf" yes;
	setAttr ".reea" no;
	setAttr ".mSceneName" -type "string" "//moon/pipeline/dev/maya/2012-x64/sceneTemplates/import_VRay_lightRig_17.ma";
...
createNode animCurveTU -n "mainLights1_visibility";
	setAttr ".tan" 2;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  40 1 41 0 42 1;
...
createNode animCurveTL -n "renderCam_translateZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  20 530 21 230;
	setAttr -s 2 ".kot[0:1]"  5 5;
createNode animCurveTL -n "renderCam_translateY";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 60 20 60 21 90;
	setAttr -s 3 ".kot[1:2]"  5 5;
createNode VRayMtl -n "VRay_greyMtl_01:grey_mtl";
...
createNode shadingEngine -n "VRay_greyMtl_01:grey_mtlSG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "VRay_greyMtl_01:materialInfo1";
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -k on ".nds";
...
relationship "link" ":lightLinker1" "VRay_greyMtl_01:grey_mtlSG.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" ":initialShadingGroup.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" ":initialParticleSE.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" "VRay_greyMtl_01:grey_mtlSG.message" ":defaultLightSet.message";
...
connectAttr "subsurface_lightShape.iog" "deleteSet.dsm" -na;
connectAttr "rim_lightShape.iog" "deleteSet.dsm" -na;
connectAttr "key_lightShape.iog" "deleteSet.dsm" -na;
connectAttr "fill_lightShape.iog" "deleteSet.dsm" -na;
connectAttr "envLightShape.iog" "deleteSet.dsm" -na;
connectAttr "renderCamShape.iog" "deleteSet.dsm" -na;
...
connectAttr "defaultRenderLayer.msg" "deleteSet.dnsm" -na;
connectAttr ":initialShadingGroup.msg" "deleteSet.dnsm" -na;
connectAttr ":initialParticleSE.msg" "deleteSet.dnsm" -na;
connectAttr "VRay_greyMtl_01:grey_mtl.oc" "VRay_greyMtl_01:grey_mtlSG.ss";
connectAttr "VRay_greyMtl_01:grey_mtlSG.msg" "VRay_greyMtl_01:materialInfo1.sg";
connectAttr "VRay_greyMtl_01:grey_mtl.msg" "VRay_greyMtl_01:materialInfo1.m";
connectAttr "VRay_greyMtl_01:grey_mtlSG.pa" ":renderPartition.st" -na;
connectAttr "VRay_greyMtl_01:grey_mtl.msg" ":defaultShaderList1.s" -na;
...
// End of import_VRay_lightRig_17.ma
