...
//Name: import_VRay_rectLight_01.ma
//Last modified: Thu, Sep 13, 2012 05:11:21 PM
//Codeset: 1252
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 185.46291772232269 139.09718829174224 159.44641343460316 ;
	setAttr ".r" -type "double3" -27.938352729602379 44.999999999999964 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 296.88552590320489;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0 0 -26.016504287719727 ;
...
createNode VRaySettingsNode -s -n "vraySettings";
	...
	setAttr ".sRGBOn" yes;
	setAttr ".resf" yes;
	setAttr ".mSceneName" -type "string" "//monkey/resources/maya/2012-x64/sceneTemplates/import_VRay_rectLight_01.ma";
...
// End of import_VRay_rectLight_01.ma
