...
//Name: import_VRay_shadowMtl_02.ma
//Last modified: Wed, Jun 05, 2013 02:06:05 PM
//Codeset: 1252
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2329.8509875985246 1747.3882406988764 2329.8509875985246 ;
...
createNode script -n "sceneConfigurationScriptNode";
	setAttr ".b" -type "string" "playbackOptions -min 101 -max 301 -ast 101 -aet 301 ";
	setAttr ".st" 6;
createNode VRayMtl -n "shadow_mtl";
	addAttr -ci true -h true -sn "aal" -ln "attributeAliasList" -dt "attributeAlias";
	setAttr ".dc" -type "float3" 0 0 0 ;
	setAttr ".rlc" -type "float3" 1 1 1 ;
	setAttr ".rlca" 0.10000000149011612;
	setAttr ".rlg" 0.40000000596046448;
	setAttr ".uf" yes;
	setAttr ".trfl" no;
	setAttr ".trfr" no;
...
createNode VRayMtlWrapper -n "shadowWrapper_mtl";
	setAttr ".ms" yes;
	setAttr ".ac" -1;
	setAttr ".sh" yes;
	setAttr ".aa" yes;
	setAttr ".stc" -type "float3" 1 1 1 ;
	setAttr ".rfla" 0;
	setAttr ".rfra" 0;
createNode shadingEngine -n "VRayMtlWrapper1SG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
...
select -ne :defaultResolution;
	...
	setAttr -av -k on ".al";
	setAttr -av ".dar" 1.6666666269302368;
...
relationship "link" ":lightLinker1" "VRayMtlWrapper1SG.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" ":initialShadingGroup.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" ":initialParticleSE.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" "VRayMtl1SG.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" "VRayMtlWrapper1SG.message" ":defaultLightSet.message";
connectAttr "layerManager.dli[0]" "defaultLayer.id";
connectAttr "renderLayerManager.rlmi[0]" "defaultRenderLayer.rlid";
connectAttr "shadow_mtl.oc" "VRayMtl1SG.ss";
connectAttr "VRayMtl1SG.msg" "materialInfo1.sg";
connectAttr "shadow_mtl.msg" "materialInfo1.m";
connectAttr "shadow_mtl.oc" "shadowWrapper_mtl.bm";
connectAttr "shadowWrapper_mtl.oc" "VRayMtlWrapper1SG.ss";
connectAttr "VRayMtlWrapper1SG.msg" "materialInfo2.sg";
connectAttr "shadowWrapper_mtl.msg" "materialInfo2.m";
connectAttr "shadowWrapper_mtl.msg" "materialInfo2.t" -na;
connectAttr "VRayMtl1SG.pa" ":renderPartition.st" -na;
connectAttr "VRayMtlWrapper1SG.pa" ":renderPartition.st" -na;
connectAttr "shadow_mtl.msg" ":defaultShaderList1.s" -na;
connectAttr "shadowWrapper_mtl.msg" ":defaultShaderList1.s" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
// End of import_VRay_shadowMtl_02.ma
