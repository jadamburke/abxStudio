...
//Name: import_VRay_lightRig_15.ma
//Last modified: Fri, Feb 15, 2013 04:07:18 PM
//Codeset: 1252
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1392.839440593508 825.86295864757665 1264.4475419872813 ;
	setAttr ".r" -type "double3" -23.738352729656004 50.599999999999973 -2.5054370439963221e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 2084.8855453581473;
...
createNode VRaySettingsNode -s -n "vraySettings";
	...
	setAttr ".vfbSA" -type "Int32Array" 144 569 6 480 337 723 562
		 ...
		 1 1 0 0 0 0 ;
	setAttr ".sRGBOn" yes;
	setAttr ".mSceneName" -type "string" "//moon/pipeline/dev/maya/2012-x64/sceneTemplates/import_VRay_lightRig_15.ma";
...
createNode animCurveTL -n "renderCam_translateY";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  20 60 21 90;
	setAttr -s 2 ".kot[0:1]"  5 5;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
...
// End of import_VRay_lightRig_15.ma
