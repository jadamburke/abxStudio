...
//Name: import_VRay_elements_03.ma
//Last modified: Wed, May 29, 2013 02:57:38 PM
//Codeset: 1252
requires maya "2012";
...
createNode VRaySettingsNode -s -n "vraySettings";
	...
	setAttr ".pxa" 1.0659999847412109;
	...
	setAttr ".sRGBOn" yes;
	setAttr ".resf" yes;
	setAttr ".mSceneName" -type "string" "//moon/pipeline/dev/maya/2012-x64/sceneTemplates/import_VRay_elements_03.ma";
...
createNode VRayRenderElement -n "vrayRE_BumpNormals";
	addAttr -ci true -sn "vrayClassType" -ln "vrayClassType" -dt "string";
	addAttr -ci true -k true -sn "enabled" -ln "enabled" -dv 1 -min 0 -max 1 -at "bool";
	addAttr -ci true -sn "vray_name_bumpnormals" -ln "vray_name_bumpnormals" -dt "string";
	addAttr -ci true -sn "vray_filtering_bumpnormals" -ln "vray_filtering_bumpnormals" 
		-dv 1 -at "long";
	setAttr ".vrayClassType" -type "string" "bumpNormalsChannel";
	setAttr ".vray_name_bumpnormals" -type "string" "bumpnormals";
createNode samplerInfo -n "pointWorld";
createNode VRayRenderElement -n "vrayRE_PointWorld";
	addAttr -ci true -sn "vrayClassType" -ln "vrayClassType" -dt "string";
	addAttr -ci true -k true -sn "enabled" -ln "enabled" -dv 1 -min 0 -max 1 -at "bool";
...
select -ne :defaultRenderGlobals;
	...
	setAttr ".renderPreset" -type "string" "HI";
select -ne :defaultResolution;
	setAttr -av -k on ".cch";
	setAttr -k on ".ihi";
	setAttr -av -k on ".nds";
	setAttr -k on ".bnm";
	setAttr -av -k on ".w" 720;
	setAttr -av -k on ".h" 432;
	setAttr -av -k on ".pa" 1.0659999847412109;
...
connectAttr "pointWorld.pw" "vrayRE_PointWorld.vray_texture_extratex";
connectAttr "pointWorld.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
// End of import_VRay_elements_03.ma
